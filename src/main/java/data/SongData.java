...
public class SongData {
     ...
     */
    public SongData(int id, String title, String artist, String genre, String difficulty, String language, String audioPath, String lyricsPath, String artCoverPath) {
        this.id = id;
        this.title = title;
        this.artist = artist;
        this.genre = genre;
